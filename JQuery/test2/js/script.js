...
class vratDataJson{
    ...
    constructor(){
            ...
            var jsondata =  '[' +
                            '  { "row": 0, "data":["package PridejTabulku;", " True", " False", " True"] },' +
                            '  { "row": 1, "data":["import sql_gui.*;", " True", " False", " True"] },' +
                            '  { "row": 2, "data":["import java.sql.DatabaseMetaData;", " True", " False", " True"] },' +
                            '  { "row": 3, "data":["import java.sql.DriverManager;", " True", " False", " True"] },' +
                            '  { "row": 4, "data":["import java.sql.ResultSet;", " True", " False", " True"] },' +
                            '  { "row": 5, "data":["import java.sql.SQLException;", " True", " False", " True"] },' +
                            '  { "row": 6, "data":["import java.sql.Statement;", " True", " False", " True"] },' +
                            '  { "row": 7, "data":["import java.util.ArrayList;", " True", " False", " True"] }' +
                            ']';


            var promenneAIndexy =   '[' +
                                    '  { "variable": "poleRadku", "columns": [0] },' +
                                    '  { "variable": "jeTotoKod", "columns": [1] },' +
                                    '  { "variable": "klicoveSlovo", "columns": [2] },' +
                                    '  { "variable": "koncovyStrednik", "columns": [3] }' +
                                    ']';
